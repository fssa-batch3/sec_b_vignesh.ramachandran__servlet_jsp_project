...
<link rel="stylesheet" href="../styles/category_add.css">
...
<body>
		...
		<section>
			<form action="create" method="post" class="form_id">
				...
				<div class="input_group">
					...
					<input
						type="url" class="category_image" name="category_image"
	...
	<form action="create" method="post">
		...
		<label>Select Menu</label> <Select name="menuId" required>
			<option value="">Select</option>
			<%
			for (Menu obj : menuList) {
			%>
			...
			%>
		</Select> <label>Category Name</label> <input type="text" name="category_name">

		<label>Category Image</label> <input type="text" name="category_image">
