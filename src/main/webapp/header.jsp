...
<body>
	...
	<header>
	    ...
	    <ul class="navigation" id="sidenav">
	        ...
	        <li><a href="/srcateringweb/index" class="navigation-link">HOME</a></li>
	        <li class="dropdown">
	            <span class="navigation-link">MENU</span>
	            <div class="dropdown-content">
	            	<div>
	            		<%for(Menu menu:menuList){ %>
	            			<a href="menus?menuId=<%=menu.getId()%>"><%=menu.getMenuName() %></a>
	            		<%} %>
	            	</div>
	        ...
	        <div class = "cartu">
	            <li><a href="" class="navigation-link">MY CART</a></li>
    	...
    	<%if(loggedUser != null) {%>
		    <div class="dropdown_profile">
		        ...
		        <div class="dropdown_profile-content">
					<div>
						<a href="user/details">My Profile</a>
			            <a href="">My Orders</a>
					</div>				
		        </div>
		    </div>
